...
export const AI_VISUALS: GridProject[] = [
  ...
  },
  {
    ...
    description: "Hyper-real human faces conjured entirely from generative neural networks.",
    techStack: ["Stable Diffusion", "ControlNet", "Python", "ComfyUI"],
    colorFrom: "#a855f7",
    colorTo: "#ec4899",
    videoSrc: "https://res.cloudinary.com/dpm8hbhff/video/upload/q_auto/f_auto/v1781002091/Forbes_properties_-_Real_estate_qd8fpx.mp4",
  },
...
export const BRAND_FILM: GridProject[] = [
  ...
  },
  {
    ...
    category: "Brand Film",
    year: "2024",
    role: "Brand Cinematographer",
    description: "A prestige brand film that weaponises elegance to communicate heritage.",
    techStack: ["Brand Identity", "AI Styling", "Colour Grade", "VFX"],
    colorFrom: "#f59e0b",
    colorTo: "#ec4899",
    videoSrc: "https://res.cloudinary.com/dpm8hbhff/video/upload/q_auto/f_auto/v1781001863/Bulgari_premium_concept_azbzdo.mov",
  },
