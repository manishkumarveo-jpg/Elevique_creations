...
export default function LeadsLandingClient() {
                        ...
                        >
                          {SERVICES.map((s) => (
                            <button
                              ...
                              type="button"
                              role="option"
                              aria-selected={form.service_type === s}
                ...
                <div className="leads-field">
                  ...
                  <div className="leads-select-wrapper">
                    <button
                      ...
                      aria-controls="videos-count-listbox"
                    ...
                    <AnimatePresence>
                      {activeDropdown === "videos" && (
                        <motion.div
                          id="videos-count-listbox"
                          role="listbox"
                          aria-label="Select video count"
                          className="leads-select-options"
                          initial={{ opacity: 0, y: -8 }}
                          animate={{ opacity: 1, y: 0 }}
                          exit={{ opacity: 0, y: -8 }}
                        ...
                        >
                          {VIDEO_COUNTS.map((v) => (
                            <button
                              ...
                              type="button"
                              role="option"
                              aria-selected={form.videos_count === v}
                  ...
                  <div className="leads-phone-row">
                    <div className="leads-select-wrapper leads-country-code">
                      <button
                        type="button"
                        aria-haspopup="listbox"
                        aria-expanded={activeDropdown === "phone"}
                          ...
                          >
                            {COUNTRY_CODES.map((c) => (
                              <button
                                ...
                                type="button"
                                role="option"
                                aria-selected={form.phone_code === c.code}
