...
import { updateMilestoneStatus } from '@/dashboard/lib/actions/milestones/update-milestone'
...
export function MilestoneControls({ milestones, projectId }: { milestones: Milestone[]; projectId: string }) {
  ...
  function handleSave() {
    ...
    startTransition(async () => {
      await updateMilestoneStatus(selected, projectId, { status })
      setStatus('')
      setSuccess(true)
