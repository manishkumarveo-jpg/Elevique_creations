          ...
          <div className="ft-content">
            ...
            <div className="ft-left">
              ...
              <p className="ft-copyright">
                © 2026 Elevique Creations. All rights reserved.
              </p>
            </div>
            ...
            <div className="ft-right">
              ...
              <div className="ft-col">
                ...
                <ul className="ft-list" role="list">
                  ...
                  <li>
                    <a
                      href="https://www.instagram.com/eleviquecreations?igsh=OHIycGg5ZnF5c2Y2&utm_source=q"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="ft-link"
                    >
                  ...
                  <li>
                    <a
                      href="https://www.linkedin.com/company/elevique-creations/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="ft-link"
                    >
